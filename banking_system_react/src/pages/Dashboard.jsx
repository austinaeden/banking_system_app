 ...
 * Displays financial overview, account balances, spending charts, and recent activity.
 */
export default function Dashboard({ accounts, transactions }) {
  ...
  // Only show the 5 most recent transactions on the dashboard
            ...
            <CardContent>
              ...
              <div className="mt-4 flex items-center gap-2">
                <div className="w-full bg-slate-100 h-1.5 rounded-full overflow-hidden">
                  {/* Progress bar visual for account status */}
            ...
            {recentTransactions.map((tx) => (
              <div key={tx.id} className="flex items-center justify-between p-4 rounded-xl hover:bg-slate-50 transition-colors group">
                <div className="flex items-center gap-4">
                  {/* Transaction Type Icon (Deposit vs Withdrawal) */}
